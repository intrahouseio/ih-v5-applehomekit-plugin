...
exports.uuidFromCharacteristic = exports.characteristicFromUuid = exports.ensureCharacteristicUuid = void 0;
...
const CharacteristicMapByUuid = {
    ...
    [`000000AE${UuidSuffix}`]: 'public.hap.characteristic.air-quality.target',
    ...
    [`000000BE${UuidSuffix}`]: 'public.hap.characteristic.slat.state.target',
    ...
    [`00000144${UuidSuffix}`]: 'public.hap.characteristic.supported-characteristic-value-transition-configuration',
    ...
    [`00000229${UuidSuffix}`]: 'public.hap.characteristic.video-analysis-active',
    [`0000022B${UuidSuffix}`]: 'public.hap.characteristic.current-transport',
    [`0000022C${UuidSuffix}`]: 'public.hap.characteristic.wifi-capabilities',
    [`0000022D${UuidSuffix}`]: 'public.hap.characteristic.wifi-configuration-control',
    [`00000232${UuidSuffix}`]: 'public.hap.characteristic.operating-state-response',
    ...
    [`00000238${UuidSuffix}`]: 'public.hap.characteristic.supported-diagnostics-snapshot',
    [`0000023A${UuidSuffix}`]: 'public.hap.characteristic.sleep-interval',
    ...
    [`0000023F${UuidSuffix}`]: 'public.hap.characteristic.received-signal-strength-indication',
    [`00000241${UuidSuffix}`]: 'public.hap.characteristic.signal-to-noise-ratio',
    [`00000242${UuidSuffix}`]: 'public.hap.characteristic.transmit-power',
    [`00000243${UuidSuffix}`]: 'public.hap.characteristic.maximum-transmit-power',
    [`00000244${UuidSuffix}`]: 'public.hap.characteristic.receiver-sensitivity',
    ...
    [`00000247${UuidSuffix}`]: 'public.hap.characteristic.mac.retransmission-maximum',
    ...
    [`00000264${UuidSuffix}`]: 'public.hap.characteristic.nfc-access-control-point',
    [`00000265${UuidSuffix}`]: 'public.hap.characteristic.nfc-access-supported-configuration',
    ...
    [`0000026C${UuidSuffix}`]: 'public.hap.characteristic.hardware.finish',
...
const CharacteristicMapByCharacteristic = Object.assign({}, ...Object.entries(CharacteristicMapByUuid).map(([a, b]) => ({ [b]: a })));
/**
 ...
 */
function ensureCharacteristicUuid(uuid) {
    if (uuid.length <= 8) {
...
exports.ensureCharacteristicUuid = ensureCharacteristicUuid;
/**
...
exports.characteristicFromUuid = characteristicFromUuid;
/**
...
exports.uuidFromCharacteristic = uuidFromCharacteristic;
